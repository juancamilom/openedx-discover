          ...
          <div className="text-center">
            ...
            <div className="mb-4">
              ...
              <div className="flex flex-wrap md:flex-nowrap justify-center items-center gap-4 mb-6">
                <Button variant={filters.category === "platform-native" ? "default" : "outline"} size="lg" onClick={() => handleFilterChange("category", "platform-native")} className="h-16 w-72 px-4 text-center">
                ...
                <Button variant={filters.category === "platform-connector" ? "default" : "outline"} size="lg" onClick={() => handleFilterChange("category", "platform-connector")} className="h-16 w-72 px-4 text-center">
                  <div className="flex items-center gap-3">
                ...
                <Button variant={filters.category === "courseware-native" ? "default" : "outline"} size="lg" onClick={() => handleFilterChange("category", "courseware-native")} className="h-16 w-72 px-4 text-center">
                  <div className="flex items-center gap-3">
                ...
                <Button variant={filters.category === "courseware-connector" ? "default" : "outline"} size="lg" onClick={() => handleFilterChange("category", "courseware-connector")} className="h-16 w-72 px-4 text-center">
                  <div className="flex items-center gap-3">
                ...
                <Button variant={filters.category === "all" ? "default" : "outline"} size="lg" onClick={() => handleFilterChange("category", "all")} className="h-16 w-44 px-6">
